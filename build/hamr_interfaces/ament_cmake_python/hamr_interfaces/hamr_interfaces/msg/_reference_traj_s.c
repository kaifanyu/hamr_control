...
bool hamr_interfaces__msg__reference_traj__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hamr_interfaces.msg._reference_traj.ReferenceTraj", full_classname_dest, 49) == 0);
  }
  hamr_interfaces__msg__ReferenceTraj * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of ReferenceTraj */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("hamr_interfaces.msg._reference_traj");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ReferenceTraj");
