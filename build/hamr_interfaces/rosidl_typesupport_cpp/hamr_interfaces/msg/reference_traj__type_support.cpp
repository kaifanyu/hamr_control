...
static const _ReferenceTraj_type_support_symbol_names_t _ReferenceTraj_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hamr_interfaces, msg, ReferenceTraj)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, hamr_interfaces, msg, ReferenceTraj)),
  }
};
...
{
  return &::hamr_interfaces::msg::rosidl_typesupport_cpp::ReferenceTraj_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, hamr_interfaces, msg, ReferenceTraj)() {
  return get_message_type_support_handle<hamr_interfaces::msg::ReferenceTraj>();
}
